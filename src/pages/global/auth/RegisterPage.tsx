                ...
                <section className="flex-1 h-full max-h-full max-w-full mx-auto bg-white rounded-lg">
                    <div className="grid grid-cols-1 lg:grid-cols-2 justify-items-center">
                        ...
                        <div className="p-9 pt-12 w-full max-w-[550px] h-[645px] relative">
                            ...
                            <p className="mb-1 text-[14px] lg:text-base text-left text-placeholder font-Manrope-Regular">
                                Welcome back
                            </p>
                            <form className="w-full mt-7" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="flex flex-col gap-y-5">
                                    ...
                                    <div className="flex flex-col gap-y-3">
                                        ...
                                        <div className="h-[56px] lg:h-[60px] relative">
                                            <input
                                                {...register("password")}
                                                className="w-full h-full px-4 pr-6 py-1 bg-inputFieldBg rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 text-base font-Manrope-Regular"
                                ...
                                <button
                                    disabled={!formValid}
                                    className={`${formValid ? "bg-brandColor hover:bg-brandColor/90 text-white" : "bg-formDisabledBg"} mt-5 block w-full px-12 py-4 font-Manrope-Regular text-base text-center transition-colors duration-150  border border-transparent rounded-lg  focus:outline-none focus:shadow-outline-blue`}
                                >
                                ...
                                <div className="mt-3 flex justify-center text-[14px]">
                                    <p className="font-Manrope-Light">
                                        Have an account?
                                        <Link to="/" className="text-brandColor hover:underline font-Manrope-SemiBold"> Create account</Link>
                                    </p>
                                </div>
